...
<h1 style="color: #0056b3; border-bottom: 2px solid #0056b3;">MINT SCAN v8.1 — USER GUIDE</h1>

<p>Welcome to <strong>Mint Scan v8.1</strong>, the world-standard security auditing and system utility suite for Linux. This guide provides comprehensive instructions for installation, usage, and optimization.</p>
...
<p>Version 8.2 includes <strong>advanced security hardening</strong>:</p>
<ul>
